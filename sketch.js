...
function setup() {
  ...
  // EINHEITLICHE TOPBAR (Professionelles Dunkelblau)
  ...
  typeSelect.style('background', '#e74c3c').style('color', '#fff').style('border', 'none').style('border-radius', '4px')
...
function windowResized() {
  ...
  quadratApp.updateLayout();
  rundApp.updateLayout();
  wabeApp.updateLayout();
  redraw();
}
