...
class MandalaRund {
  ...
  init(topBarContainer) {
    ...
    this.codeDisplay = createSpan("").parent(codeGroup).style('font-size', isMobile ? '11px' : '14px').style('color', '#fff').style('font-weight', '600').style('letter-spacing', '1px');
  ...
  hide() { if(this.sliderPanel) this.sliderPanel.hide(); if(this.modeSelect) { this.modeSelect.hide(); this.inputField.hide(); this.sektS.hide(); this.richtungS.hide(); this.codeDisplay.hide(); } }
  show() { if(this.sliderPanel) this.sliderPanel.show(); if(this.modeSelect) { this.modeSelect.show(); this.inputField.show(); this.sektS.show(); this.richtungS.show(); this.codeDisplay.show(); } }
}
